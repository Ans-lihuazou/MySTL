...
namespace MySTL {
	...
	//distance ����������ľ���
	//һ��һ������:InputIterator,OutputIterator,ForwardIterator,BidirectionalIterator
	...
	void _advance(InputIterator& it, Distance n, input_iterator_tag) {//����һ��һ��
		assert(n >= 0);
		while (n--) ++it;
	}
	template<class BidirectionIterator, class Distance>//ǰ��һ��һ��
